...
fn write_variant_data_to_chezmoi(
    ...
    // Phase A (steel-poc): variant resolver removed; write selections directly.
    ...
    for (slot, value) in &current_selections {
        set_slot_in_chezmoidata(&mut table, slot, Some(value.as_str()));
    }

...
(autoload 'wakatime-update-cli "wakatime-mode"
"Force an immediate check for wakatime-cli updates, ignoring the rate-limit." t)
(autoload 'wakatime-mode "wakatime-mode"
"Toggle WakaTime (WakaTime mode).

This is a minor mode.  If called interactively, toggle the `wakatime
...
evaluate the variable `wakatime-mode'.
...
"Toggle Wakatime mode in many buffers.
Specifically, Wakatime mode is enabled in all buffers where `(lambda
nil (wakatime-mode 1))' would do it.

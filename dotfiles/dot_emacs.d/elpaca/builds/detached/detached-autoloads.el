...
`detached-shell mode' mode.  If the prefix argument is positive, enable
...
evaluate the variable `detached-shell-mode'.
...
This mode runs the hook `detached-log-mode-hook', as the final or
penultimate step during initialization.

\\{detached-log-mode-map}" t)
...
run, this mode runs the hook `detached-compilation-mode-hook', as the
final or penultimate step during initialization.

\\{detached-compilation-mode-map}" t)
...
This is a minor mode.  If called interactively, toggle the
`detached-eshell mode' mode.  If the prefix argument is positive, enable
the mode, and if it is zero or negative, disable the mode.
...
To check whether the minor mode is enabled in the current buffer,
evaluate the variable `detached-eshell-mode'.
...
This is a minor mode.  If called interactively, toggle the
`detached-vterm mode' mode.  If the prefix argument is positive, enable
the mode, and if it is zero or negative, disable the mode.
...
To check whether the minor mode is enabled in the current buffer,
evaluate the variable `detached-vterm-mode'.

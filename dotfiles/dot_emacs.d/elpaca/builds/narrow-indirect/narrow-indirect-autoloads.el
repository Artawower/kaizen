;;; narrow-indirect-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(fn START END HERE &optional FULL-NAME TEXT MSGP)" t)
...
(fn &optional ARG)" t)
(register-definition-prefixes "narrow-indirect" '("ni-"))

;;; End of scraped data

(provide 'narrow-indirect-autoloads)

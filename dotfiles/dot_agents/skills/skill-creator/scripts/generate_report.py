#!/usr/bin/env python3
"""Generate an HTML report from loop.py output.

Takes the JSON output from loop.py and generates a visual HTML report
...
def main():
    ...
    parser.add_argument(
        "input", help="Path to JSON output from loop.py (or - for stdin)"
    )
    parser.add_argument(
